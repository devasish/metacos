...
?>
<?php 
echo $this->Form->create('SubjectWqt');
...
<a href="javascript:void(0)" onclick="printData('Wqts-Print')" class="print print-btn1" rel="Wqts-Print"><i class="fa fa-print"></i>&nbsp;Print</a>
</h3>
...
<table class="table table-bordered">
    ...
    <tr>
        <td><label class="bmd-label-floating">Welder's Name:</label></td>
        <td><?php echo $this->Form->input('welder_three_name',  array('class' => 'form-control', 'label' => FALSE)); ?></td>
        <td><label class="bmd-label-floating">IC No.:</label></td>
        <td><?php echo $this->Form->input('welder_three_icno',  array('class' => 'form-control', 'label' => FALSE)); ?></td>
        <td><label class="bmd-label-floating">Tag No.:</label></td>
        <td><?php echo $this->Form->input('welder_three_tagno',  array('class' => 'form-control', 'label' => FALSE)); ?></td>
        <td><label class="bmd-label-floating">Process:</label></td>
        <td><?php echo $this->Form->input('welder_three_process',  array('class' => 'form-control', 'label' => FALSE)); ?></td>
    </tr>
</table>
<div class="clearfix"></div>
<table class="table table-bordered">
...
<div class="clearfix"></div>
<h3>B2: Non-Destructive Mechanical Test (s) Required</h3>
<table class="table table-bordered">
    <tr>
    ...
    <tr>
        ...
        <td><?php echo $this->Form->input('radiography_x_ray',  array('class' => 'form-control', 'label' => FALSE)); ?></td>
    </tr>
    <tr>
...
<div class="clearfix"></div>
<h3>B3: Non-Destructive Mechanical Test (s) Required</h3>
<table class="table table-bordered">
    <tr>
    ...
    <tr>
        ...
        <td><label class="bmd-label-floating">Transverse Face Bend Test</label></td>
        <td><?php echo $this->Form->input('transverse_face_bend_test',  array('class' => 'form-control', 'label' => FALSE)); ?></td>
    </tr>
    <tr>
        <td><label class="bmd-label-floating">Transverse Root Bend Test</label></td>
        <td><?php echo $this->Form->input('transverse_root_bend_test',  array('class' => 'form-control', 'label' => FALSE)); ?></td>
        <td><label class="bmd-label-floating">Nick Break (API 1104)</label></td>
        <td><?php echo $this->Form->input('nick_break_api1104',  array('class' => 'form-control', 'label' => FALSE)); ?></td>
    </tr>
    <tr>
    ...
    <tr>
        <td><label class="bmd-label-floating">Fracture Test (Fillet Weld)</label></td>
        <td><?php echo $this->Form->input('fracture_test_fillet_weld',  array('class' => 'form-control', 'label' => FALSE)); ?></td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
    </tr>
</table>
...
<button  class="btn btn-success submit-btn" type="submit" >Submit</button>
        ...
        <!---------------------Print Section------------------------->
        <div id="Wqts-Print" class="print-hidden">
            ...
            <table cellpadding="0" cellspacing="0" class="table table-bordered tabprint">
                <tr>
                    ...
                    <td><?php echo $this->Form->value('welder_one_process'); ?></td>
                </tr>
                <tr>
                    <td><label class="bmd-label-floating">Welder's Name:</label></td>
                ...
                <tr>
                    <td><label class="bmd-label-floating">Welder's Name:</label></td>
                    <td><?php echo $this->Form->value('welder_three_name'); ?></td>
                    <td><label class="bmd-label-floating">IC No.:</label></td>
                    <td><?php echo $this->Form->value('welder_three_icno'); ?></td>
                    <td><label class="bmd-label-floating">Tag No.:</label></td>
                    <td><?php echo $this->Form->value('welder_three_tagno'); ?></td>
                    <td><label class="bmd-label-floating">Process:</label></td>
                    <td><?php echo $this->Form->value('welder_three_process'); ?></td>
                </tr>
            </table>
            <br>
            <div class="clearfix"></div>
            <table cellpadding="0" cellspacing="0" class="table table-bordered tabprint">
                <tr>
                    <td width="12%"><label class="bmd-label-floating">Test Code:</label></td>
            ...
            <table cellpadding="0" cellspacing="0" class="table table-bordered tabprint">
                ...
                <tr>
                    ...
                    <td><label class="bmd-label-floating">Radiography (X Ray)</label></td>
                    <td><?php echo $this->Form->value('radiography_x_ray'); ?></td>
                </tr>
                <tr>
                    <td><label class="bmd-label-floating">Dye Penetrant Test</label></td>
            ...
            <table cellpadding="0" cellspacing="0" class="table table-bordered tabprint">
                ...
                <tr>
                    ...
                    <td><label class="bmd-label-floating">Transverse Face Bend Test</label></td>
                    <td><?php echo $this->Form->value('transverse_face_bend_test'); ?></td>
                </tr>
                <tr>
                    <td><label class="bmd-label-floating">Transverse Root Bend Test</label></td>
                    <td><?php echo $this->Form->value('transverse_root_bend_test'); ?></td>
                    <td><label class="bmd-label-floating">Nick Break (API 1104)</label></td>
                    <td><?php echo $this->Form->value('nick_break_api1104'); ?></td>
                </tr>
                <tr>
                    <td><label class="bmd-label-floating">Transverse Side Bend Test</label></td>
                ...
                <tr>
                    <td><label class="bmd-label-floating">Fracture Test (Fillet Weld)</label></td>
                    <td><?php echo $this->Form->value('fracture_test_fillet_weld'); ?></td>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
                </tr>
            </table>
...
<?php echo $this->Form->create('SubjectWqt'); ?>
	<fieldset>
		<legend><?php echo __('Edit Subject Wqt'); ?></legend>
	<?php
		echo $this->Form->input('id');
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('SubjectWqt.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('SubjectWqt.id'))); ?></li>
