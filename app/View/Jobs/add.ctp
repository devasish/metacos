				...
				<div class="card-body">
					...
					<table class="table table-bordered">
						<tr>
							...
							<td colspan="3">
								<?php echo $this->Form->input('client',  array('class' => 'form-control', 'label' => FALSE, 'value' => isset($user['User']['client']) ? $user['User']['client'] : "")); ?>
							</td>
						</tr>
						<tr>
							<td><label class="bmd-label-floating">Address</label></td>
							<td colspan="3">
								<?php echo $this->Form->input('address',  array('class' => 'form-control', 'label' => FALSE, 'value' => isset($user['User']['address']) ? $user['User']['address'] : "")); ?>
							</td>
						</tr>
						<tr>
							<td><label class="bmd-label-floating">Telephone</label></td>
							<td>
								<?php echo $this->Form->input('phone',  array('class' => 'form-control', 'label' => FALSE, 'value' => isset($user['User']['phone']) ? $user['User']['phone'] : "")); ?>
							</td>
							<td><label class="bmd-label-floating">Fax</label></td>
							<td>
								<?php echo $this->Form->input('fax',  array('class' => 'form-control', 'label' => FALSE, 'value' => isset($user['User']['fax']) ? $user['User']['fax'] : "")); ?>
							</td>
						</tr>
						<tr>
							<td><label class="bmd-label-floating">Email</label></td>
							<td>
								<?php echo $this->Form->input('email',  array('class' => 'form-control', 'label' => FALSE, 'value' => isset($user['User']['email']) ? $user['User']['email'] : "")); ?>
							</td>
							<td><label class="bmd-label-floating">Contact Person</label></td>
							<td>
								<?php echo $this->Form->input('contact_person',  array('class' => 'form-control', 'label' => FALSE, 'value' => isset($user['User']['contact_person']) ? $user['User']['contact_person'] : "")); ?>
							</td>
						</tr>
					</table>
					...
					<table class="table table-bordered">
						<tr>
							<td><label class="bmd-label-floating">Client</label></td>
							<td colspan="3">
								<?php echo $this->Form->input('report_client',  array('class' => 'form-control', 'label' => FALSE, 'value' => isset($user['User']['client']) ? $user['User']['client'] : "")); ?>
							</td>
						</tr>
						<tr>
							<td><label class="bmd-label-floating">Address</label></td>
							<td colspan="3">
								<?php echo $this->Form->input('report_address',  array('class' => 'form-control', 'label' => FALSE, 'value' => isset($user['User']['address']) ? $user['User']['address'] : "")); ?>
							</td>
						</tr>
						<tr>
							<td><label class="bmd-label-floating">Telephone</label></td>
							<td>
								<?php echo $this->Form->input('report_phone',  array('class' => 'form-control', 'label' => FALSE, 'value' => isset($user['User']['phone']) ? $user['User']['phone'] : "")); ?>
							</td>
							<td><label class="bmd-label-floating">Fax</label></td>
							<td>
								<?php echo $this->Form->input('report_fax',  array('class' => 'form-control', 'label' => FALSE, 'value' => isset($user['User']['fax']) ? $user['User']['fax'] : "")); ?>
							</td>
						</tr>
						<tr>
							<td><label class="bmd-label-floating">Email</label></td>
							<td>
								<?php echo $this->Form->input('report_email',  array('class' => 'form-control', 'label' => FALSE, 'value' => isset($user['User']['email']) ? $user['User']['email'] : "")); ?>
							</td>
							<td><label class="bmd-label-floating">Contact Person</label></td>
							<td>
								<?php echo $this->Form->input('report_att_to',  array('class' => 'form-control', 'label' => FALSE, 'value' => isset($user['User']['contact_person']) ? $user['User']['contact_person'] : "")); ?>
							</td>
						</tr>
					</table>
					<div class="clearfix"></div>
					...
					<table class="table table-bordered">
						<tr>
							<td><label class="bmd-label-floating">Client</label></td>
							<td colspan="3">
								<?php echo $this->Form->input('invoice_client',  array('class' => 'form-control', 'label' => FALSE, 'value' => isset($user['User']['client']) ? $user['User']['client'] : "")); ?>
							</td>
						</tr>
						<tr>
							<td><label class="bmd-label-floating">Address</label></td>
							<td colspan="3">
								<?php echo $this->Form->input('invoice_address',  array('class' => 'form-control', 'label' => FALSE, 'value' => isset($user['User']['address']) ? $user['User']['address'] : "")); ?>
							</td>
						</tr>
						<tr>
							<td><label class="bmd-label-floating">Telephone</label></td>
							<td>
								<?php echo $this->Form->input('invoice_phone',  array('class' => 'form-control', 'label' => FALSE, 'value' => isset($user['User']['phone']) ? $user['User']['phone'] : "")); ?>
							</td>
							<td><label class="bmd-label-floating">Fax</label></td>
							<td>
								<?php echo $this->Form->input('invoice_fax',  array('class' => 'form-control', 'label' => FALSE, 'value' => isset($user['User']['fax']) ? $user['User']['fax'] : "")); ?>
							</td>
						</tr>
						<tr>
							<td><label class="bmd-label-floating">Email</label></td>
							<td>
								<?php echo $this->Form->input('invoice_email',  array('class' => 'form-control', 'label' => FALSE, 'value' => isset($user['User']['email']) ? $user['User']['email'] : "")); ?>
							</td>
							<td><label class="bmd-label-floating">Contact Person</label></td>
							<td>
								<?php echo $this->Form->input('invoice_contact_person',  array('class' => 'form-control', 'label' => FALSE, 'value' => isset($user['User']['contact_person']) ? $user['User']['contact_person'] : "")); ?>
							</td>
						</tr>
					</table>
					<div class="clearfix"></div>
						...
						<tr>
							...
							<td>
								<?php echo $this->Form->input('witnessing_party_organization',  array('class' => 'form-control', 'label' => FALSE)); ?>
                                        ...
                                        <?php
                                            echo $this->Form->input('subject', array("type" => "select", 'class' => 'form-control', "options" => Configure::read('JOBSUBJECTS')));
                                        ?>
					<div class="clearfix"></div>
					<h3>Note :-</h3>
